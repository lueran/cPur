...
public class StoryViewHolder extends RecyclerView.ViewHolder {
    ...
    private final GlideRequests with;
    ...
    public void bindToStory(StoryAllParagraph storyAllParagraph) {
        ...
        switch (story.getCurrentStatus()) {
            ...
            case IN_PROGRESS:
                ...
                statusImage.setImageResource(R.drawable.ic_join);
                ...
                clapsImage.setImageResource(R.drawable.ic_sync_black_24dp);
                break;
            case COMPLETED:
                statusImage.setColorFilter(0);
                statusImage.setImageResource(R.drawable.ic_glasses);
                clapsImage.setImageResource(R.drawable.ic_claps);
